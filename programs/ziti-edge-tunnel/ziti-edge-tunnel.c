...
static tunneler_context tunneler;
                    ...
                    if (tnl_res_cmd.data != NULL && parse_tunnel_delete_identity(&tnl_delete_id, tnl_res_cmd.data, strlen(tnl_res_cmd.data)) >= 0) {
                        ...
                        if (id->Services) {
                            ...
                            if (model_map_size(hostnamesToRemove) > 0) {
                                ziti_tunnel_work_send(tunneler, remove_nrpt_rules, hostnamesToRemove);
                            } else {
    ...
    switch (ev->event_type) {
        ...
        case TunnelEvent_ServiceEvent: {
            ...
            if (model_map_size(hostnamesToEdit) > 0) {
                ...
                ziti_tunnel_work_send(tunneler, remove_and_add_nrpt_rules, edit_svc_req_data);
            }
            if (model_map_size(hostnamesToAdd) > 0) {
                ...
                ziti_tunnel_work_send(tunneler, add_nrpt_rules, add_svc_req_data);
            }
            if (model_map_size(hostnamesToRemove) > 0) {
                ziti_tunnel_work_send(tunneler, remove_nrpt_rules, hostnamesToRemove);
            }
